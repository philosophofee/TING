...
public class TestWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        debugVisitorTable = new javax.swing.JTable();
        ...
        debugVisitorTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "Visitor Name", "Desired Floor", "Current Floor", "Status"
            }
        ));
        jScrollPane2.setViewportView(debugVisitorTable);
    ...
    private void btnSaveScenarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveScenarioActionPerformed
        ...
        controller.saveScenario(new File(path));
    ...
    private void btnLoadScenarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadScenarioActionPerformed
        ...
        controller.loadScenario(toLoad); //open ui to load scenario file into jTable
    ...
    private javax.swing.JTable debugVisitorTable;
